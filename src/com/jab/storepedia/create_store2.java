...
public class create_store2 extends Activity {
	    ...
	    new AlertDialog.Builder(this)
	        ...
	        .setPositiveButton(android.R.string.yes, new OnClickListener() {
	            ...
	            public void onClick(DialogInterface arg0, int arg1) {
	            	create_store2.super.onBackPressed();
	            }
	        }).create().show();
	}
	@Override
	...
	{		
        ...
        params.add(new BasicNameValuePair("store_address", store_address.getText().toString()));
        params.add(new BasicNameValuePair("store_contact", store_contact.getText().toString()));
        try{
