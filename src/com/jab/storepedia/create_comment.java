	    ...
	    new AlertDialog.Builder(this)
	        ...
	        .setPositiveButton(android.R.string.yes, new OnClickListener() {
	            ...
	            public void onClick(DialogInterface arg0, int arg1) {
	            	create_comment.super.onBackPressed();
	            }
	        }).create().show();
	}
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(create_comment.this,store_detail.class);
				i.putExtra("UID", UID);
				i.putExtra("LID", LID);
				i.putExtra("SID", SID);
		...
		client.post("http://122.155.187.27:9876/create_comment.php",
				params, new AsyncHttpResponseHandler() {
					...
					public void onSuccess(String response) {
						...
						Intent i = new Intent(create_comment.this,lcomment_detail.class);
						i.putExtra("UID", UID);
						i.putExtra("LID", LID);
						i.putExtra("SID", SID);
